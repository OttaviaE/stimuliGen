...
## 	Crescente in H e decrescente in V

```{r}
M30<-apply(Raven(create_dice(square(shd="black")),"hquant","vquant.inv"))
draw(M30)

```

## 	Crescente in orizzontale e verticale 

```{r}

M31<-apply(Raven(create_dice(ellipse(shd="grey")),"hquant.x2","vquant.x2"))
draw(M31)
