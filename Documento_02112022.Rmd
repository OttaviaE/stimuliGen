...
DrawRegPolygon(x = circle()$pos.x[[1]], 
               y = circle()$pos.y[[1]], radius.x=circle()$size.x[[1]],
              radius.y = circle()$size.y[[1]], rot=circle()$rotation[[1]],
               lwd = circle()$lwd[[1]], lty=circle()$lty[[1]], nv = circle()$nv[[1]])
```
