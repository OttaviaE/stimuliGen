...
draw(diagline(pos.x=-50, s.x = 50, lwd = 5))
for(i in seq(-50, 50, by = 1.5)) {
  draw(diagline(pos.x = i, s.x=40, lwd = 5), 
       canvas = F)
}
...
## Diagonale principale color

## Diagonale secondaria

```{r}

draw(diagline.inv(pos.x=-50, s.x = 50, lwd = 5))
for(i in seq(-50, 50, by = 1.5)) {
  draw(diagline.inv(pos.x = i, s.x=40, lwd = 5), 
       canvas = F)
}
...
draw(diagline.inv(pos.x=-50, s.x = 50, lwd = 5), canvas = F)
for(i in seq(-50, 50, by = 1.5)) {
  draw(diagline.inv(pos.x = i, s.x=40, lwd = 5), 
       canvas = F)
}
...
```{r}
draw(diagline(pos.x=-50, s.x = 50, lwd = 5), bg = col)
for(i in seq(-50, 50, by = 3.5)) {
  draw(diagline(pos.x = i, s.x=40, lwd = 5), 
       canvas = F)
}
...
```{r}
draw(vline(pos.x = -20, s.x = 50, lwd = 5))
draw(vline(pos.x = 20, s.x = 50, lwd = 5, lty = 3), canvas = F)
draw(vline(pos.x = 17, s.x = 50, lwd = 5), canvas = F)

draw(hline(pos.y = -9, s.x = 50, lwd = 5, lty = 1), canvas = F)
draw(hline(pos.y = -12, s.x = 50, lwd = 5, lty = 3), canvas = F)
