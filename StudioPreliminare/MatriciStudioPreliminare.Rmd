...
dist_alogic3 = list(correct = correct(a_logic3),
                   ...
                   d.union = cof(a_logic3$Sq3, s.horizontal()),
...
resp_a1_logic3$d.union = cof(a1_logic3$Sq1, circle())

draw.dist(resp_a1_logic3, n.resp = 8, main = T)
...
resp_a1_logic2$d.union = cof(hide(a1_logic2$Sq1, c(5,6,8)),
                             hide(a1_logic2$Sq2, c(1,7, 8)), 
                             s.vertical.inv())
draw.dist(resp_a1_logic2, 
          single.print = F, main = T)
...
resp_a_logic1$d.union = cof(a_logic1$Sq3, 
                            luck())
...
resp_a1_logic1[["ic.flip"]] = cof(a1l1_p[[1]], 
                                  ...
                                  a1l1_p[[4]], 
                                  diagline())
resp_a1_logic1$d.union = cof(a1_logic1$Sq1, 
                             triangle())
...
resp_a_logic4$d.union = cof(a_logic4$Sq4, cross.dice())
...
resp_b_logic3$d.union = cof(b_logic3$Sq1, 
                            horizontal.eight())
...
resp_b1_logic3[["ic.flip"]] = cof(cross.dice(), 
                                  ...
                                  b1l3_p[[4]], 
                                  b1l3_p[[5]])
resp_b1_logic3$d.union = cof(square(shd = "line12"), 
                             b1_logic3$Sq2, 
                             bow.tie())
...
resp_b_logic2$d.union = cof(b_logic2$Sq4, s.vertical())
...
resp_b1_logic2$d.union = cof(b1_logic2$Sq3, 
                             cross.dice())
...
resp_b_logic1$d.union = cof(b_logic1$Sq1, 
                            diagline())

draw.dist(resp_b_logic1, n.resp = 8,main = t)
...
resp_b1_logic1$d.union = cof(b1_logic1$Sq1, e.hexagon())
...
resp_b_logic4$d.union = cof(b_logic4$Sq1, 
                            cross.dice())
...
resp_b1_logic4$d.union = cof(vertical.eight(), 
                     b1_logic4$Sq1)
...
resp_b1_2[["d.union"]] = cof(b1_2$Sq1, 
                             ellipse())
