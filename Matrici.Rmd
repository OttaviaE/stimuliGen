...
draw(adult001, n.cell = 9)

```


```{r out.width = "80%"}
selection.neg = c("correct", "r.top", "r.diag", "d.union", "wp.matrix", "ic.inc", "ic.scale", "ic.flip")
dist_adult001 = responses(adult001,mat.type = 9)
...
draw.dist(resp_adult001, n.resp = 8, main = T)
...
draw.dist(resp_adult002, n.resp = 11, main = T)
