...
<!--                      pentagon(s.x=3,s.y=3),pentagon(s.x=2.5,s.y=2.5,shd="grey",lty = 0)),"OR")) -->
...
## Adults042 non funziona il codice
...
## Adults044 non funziona il codice
