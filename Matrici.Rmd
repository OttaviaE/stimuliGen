...
```{r out.width="80%"}
dist_adults013 = responses(adult013)

p = split.mat(adult013)

dist_adults013$ic.flip = cof(p$square, 
                            rotation(p$X, 2))
dist_adults013$ic.scale = cof(size(p$square,2), 
                            size(p$X, 2))

sel013 = c("correct", "r.top", "r.diag", "wp.matrix", "wp.copy", "d.union",
           "ic.inc", "ic.flip")

resp_adult013 = select.dist(dist_adults013, sel013)
...
```{r out.width="80%"}
dist_adults014 = responses(adult014)

p = split.mat(adult014)

dist_adults014$ic.flip = cof((rotation(p$cross, 2)), 
                            p$dot)
dist_adults014$ic.scale = cof(size(p$cross, 2), 
                            p$dot)
...
resp_adult014 = select.dist(dist_adults014, sel014)
...
```{r out.width="80%"}
dist_adults015 = responses(adult015)

p = split.mat(adult015)

dist_adults015$ic.neg = cof(change.col(p$luck), 
                     p$X)
sel015 = c("correct","r.top", "r.left", "wp.copy",  "wp.matrix", "d.union", "ic.scale", "ic.inc")

resp_adult015 = select.dist(dist_adults015, sel015)
...
```{r out.width="80%"}
dist_adults016 = responses(adult016)
sel016 = c("correct","r.top", "r.diag", "wp.copy",  "wp.matrix", "d.union", "ic.neg", "ic.flip")

resp_adult016 = select.dist(dist_adults016, 
                            sel016)
...
```{r out.width="80%"}
dist_adults033 = responses(adult033)

dist_adults033$ic.inc =diagline(lty = 3)

sel33 = sel32

resp_adult033 = select.dist(dist_adults033, sel33)
...
```{r out.width="80%"}
dist_adults034 = responses(adult034)
sel34 = c("correct", "r.diag", "r.left", "wp.copy", "wp.matrix", "d.union", "ic.scale", "ic.flip")

resp_adult034 = select.dist(dist_adults034, 
                            sel34)
...
```{r out.width="80%"}
dist_adults035 = responses(adult035)

p = split.mat(adult035)

dist_adults035$ic.scale = (cof(size(p[[1]],2), 
                                   size(p[[2]], 2), 
                                   size(p$dot, 2), 
                               p$square))

dist_adults035$ic.flip = (cof(rotation(p[[1]],2), 
                                   rotation(p[[2]], 2), 
                                   (p$dot), 
                               p$square))

dist_adults035$ic.neg = cof(p[[1]], p[[2]], 
                                   dot(shd="white"), 
                               p$square)
...
resp_adult035 = select.dist(dist_adults035, 
                            sel35)
...
```{r out.width="80%"}
dist_adults036 = responses(adult036)

p = split.mat(adult036)
m.c = correct(adult036)
dist_adults036$ic.scale = replace(m.c, 3, size(p$croce, 2))
dist_adults036$ic.flip = replace(m.c, 3, rotation(p$croce, 2))

dist_adults036$ic.neg = replace(m.c, 2, change.col(p[[2]]))


sel36 = c("correct", "r.diag", "r.left", "wp.copy", "wp.matrix", "d.union", "ic.flip", "ic.inc")

resp_adult036 = select.dist(dist_adults036, sel36)
...
## Adults037 Non funziona il codice
...
<!-- ```{r out.width="80%"} -->
<!-- dist_adults037 = responses(adult037) -->
<!-- sel37 = c("correct", "r.diag", "r.left" , "wp.copy", "wp.matrix", "d.union", "ic.flip", "ic.neg") -->
<!-- resp_adult037 = select.dist(dist_adults037,  -->
<!--                             sel37) -->

<!-- draw.dist(dist_adults037) -->
...
```{r out.width="80%"}
dist_adults038 = responses(adult038)

dist_adults038$d.union = cof(dist_adults038$wp.matrix,
                             bow.tie())

sel38 = c("correct", "r.diag", "r.left", "wp.copy",  "wp.matrix", "d.union", "ic.flip", "ic.scale")

resp_adult038 = select.dist(dist_adults038, 
                            sel38)
...
```{r out.width="80%"}
dist_adults039 = responses(adult039)

dist_adults039$ic.inc = circle(lty = 2)

sel39 = c("correct", "r.diag", "r.left", "wp.copy", "wp.matrix", "d.union", "ic.flip", "ic.inc")

resp_adult039 = select.dist(dist_adults039, sel39)
...
```{r out.width="80%"}
dist_adults040 = responses(adult040)

p = split.mat(adult040)
m.c = correct(adult040)

p$cross.dice$shade[[1]] = rep("white", 4)
dist_adults040$ic.neg = p[[1]]
draw.dist(dist_adults040)
...
```{r out.width="80%"}
dist_adults041 = responses(adult041)

p = split.mat(adult041)
m.c = correct(adult041)
dist_adults041$ic.neg = replace(m.c, 3, change.col(p$square))

draw.dist(dist_adults041)
...
```{r out.width="80%"}
dist_adults042 = responses(adult042)

draw.dist(dist_adults042)
...
```{r out.width="80%"}
dist_adults043 = responses(adult043)

p = split.mat(adult043)
m.c = correct(adult043)
dist_adults043$ic.flip = cof(rotation(p$vline, 2), 
                             rotation(p$hline, 2), 
                             p$cross.dice, 
                             p$triangle, 
                             p$circle)
...
dist_adults043$ic.neg = replace(m.c,5, change.col(p$circle))
draw.dist(dist_adults043)
...
```{r out.width="80%"}
dist_adults044 = responses(adult044)

draw.dist(dist_adults044)
```
...
```{r out.width="80%"}
dist_adults045 = responses(adult045)

draw.dist(dist_adults045)
...
```{r out.width="80%"}
dist_adults046 = responses(adult046)

draw.dist(dist_adults046)
...
```{r out.width="80%"}
dist_adults047 = responses(adult047)

p = split.mat(adult047)

dist_adults047$ic.flip = cof(p$circle, rotation(p$triangle, 4))

draw.dist(dist_adults047)
...
```{r out.width="80%"}
dist_adults048 = responses(adult048)

p = split.mat(adult047)

dist_adults047$ic.flip = cof(p$circle, rotation(p$triangle, 4))

draw.dist(dist_adults048)
