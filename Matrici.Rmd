...
```{r out.width="80%"}
dist_young006 = responses(young006,mat.type = 4, how.rot = 4)
...
draw.dist(resp_young031, n.resp = 8)
...
Forma e Dimensione	TL-LR per la prima e V per la seconda	no	matrice 3 x 3	8 opzioni	adult011		Ottavia
...
Forma, Riempimento e Dimensione	TL-LR per la prima TR-LL per la seconda e la terza	no	matrice 3 x 3	8 opzioni	adult030