...
resp_young007[["ic.flip"]] = cof(rotation(p[[1]], 2), 
 ...
 draw.dist(resp_young007, n.resp = 11, main = T)
```
...
draw.dist(resp_young013, n.resp = 11, main = T)
```
...
draw.dist(resp_young014, n.resp = 11, main = T)
```
...
draw.dist(resp_young015, n.resp = 11, main = T)
```
...
young021a = obj_addition_rules(
  Raven(
    st1 = cof(s.lily(),size(u.biscuit, 2)) 
  ), rule="vh.sott"
)
...
draw.dist(dist_young023, n.resp = 11, main = T)
```
...
draw.dist(dist_young025, n.resp = 11, main = T)
```
